...
# === 1. Ler arquivo ===
df = pd.read_csv("./dados/original_utf8.csv")
...
top5_mulher_relativa = df.sort_values(by="Razao_Mulher_Homem", ascending=False).head(5)
...
plt.bar([i + width/2 for i in x], mulheres, width, label="Mulheres")
